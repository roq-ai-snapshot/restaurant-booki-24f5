  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of dining with Restaurant Booking Engine - Simplifying table reservations and menu management for restaurants, enhancing the dining experience for customers."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of dining with Restaurant Booking Engine - Simplifying table reservations and menu management for restaurants, enhancing the dining experience for customers.`}
            </Text>
            <Box
